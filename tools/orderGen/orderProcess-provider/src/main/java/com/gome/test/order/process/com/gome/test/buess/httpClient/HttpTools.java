...
//    }
    ...
    public static HttpPost getHttpPost( String uri,String xml) {
        HttpPost post = new HttpPost(uri);
        try {
...
//            System.out.println("Get response is : " + strResp);
    ...
    public static String getHttpResponseInfo(HttpRequestBase request) {
        String jsonBody = "";
...
//                System.out.println("Get response is : " + jsonBody);
                ...
                logger.error("返回的code：" + statusCode + "entity is :" + entity);
