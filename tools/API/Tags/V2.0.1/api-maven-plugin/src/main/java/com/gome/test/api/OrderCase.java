...
public class OrderCase {
    ...
    private static final String BASE_CONFIG_CLASS = "com.gome.test.api.testng.BaseConfig";
    ...
    public XmlSuite toXmlSuite(String testngPath,
        ...
        String suiteName = String.format("OrderCase_%s",caseDesc) ;
        ...
        parameters.put("descLevel", descLevel);
