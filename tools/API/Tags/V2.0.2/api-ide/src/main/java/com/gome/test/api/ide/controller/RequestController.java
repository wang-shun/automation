...
public class RequestController {
    ...
    public Result send(
        ...
        try {
            ...
            HttpTestContext config = new HttpTestContext(getConfigFile(Constant.API_XML),getConfigFile(Constant.API_PROP),
                    Arrays.asList(ucl.getURLs()));
            try {
            	config.setUpBeforeSuite();
                IMessageClient mc = HttpTestContext.getMessageClient();
                mc.run(kvs, false);
