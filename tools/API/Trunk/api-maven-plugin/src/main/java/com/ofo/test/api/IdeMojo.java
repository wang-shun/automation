...
import com.ofo.test.api.ide.Application;
...
//
//            Class<?> cls = Thread.currentThread().getContextClassLoader().loadClass("com.ofo.test.api.ide.Application");
...
//        }
        ...
        System.out.println("______________"+System.getProperty("app.classpath"));
