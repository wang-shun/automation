...
public class TestSource {
    ...
    public void generate(Class<? extends ITestNGListener>... listeners) throws Exception {
        ...
        if (this.atomicCases.getClientType() == ClientEnum.HttpClient)
            generateHttpDubboTestSource(false);
        else if (this.atomicCases.getClientType() == ClientEnum.TelnetClient)
            generateHttpDubboTestSource(true);
        else
    ...
    private void generateHttpDubboTestSource(boolean isDubbo) throws IOException {
        Writer writer = null;
        atomicCases.setTestCasesList();
        ...
        for(int i=0;i< atomicCases.getTestCasesList().size();i++)
        {
            ...
            try {
                ...
                String testClassHeadTpl = "/source.tpl1";
                if (isDubbo)
                    testClassHeadTpl = "/source.tpl9";
                writer.write(getSourceTemplateString(testClassHeadTpl)
    ...
    private String getMethod(AtomicCase testCase) throws IOException {
        ...
        sb.append(getSourceTemplateString(this.atomicCases.getClientType() == ClientEnum.HttpClient || this.atomicCases.getClientType() == ClientEnum.TelnetClient ? "/source.tpl2" : "/richclietsource2.tpl")
        ...
        sb.append(getSourceTemplateString(this.atomicCases.getClientType() == ClientEnum.HttpClient || this.atomicCases.getClientType() == ClientEnum.TelnetClient ? "/source.tpl3" : "/richclietsource3.tpl")
