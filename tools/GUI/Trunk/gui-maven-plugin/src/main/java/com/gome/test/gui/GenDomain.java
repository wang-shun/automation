...
public class GenDomain extends GenBase {
    ...
    protected void genByFile(File resourceFile) throws Exception {
        ...
        try {
            ...
            String packageName = Utils.getPageDataPackageName(resourceFile);
            String maiFolderPath =String.format("%s%ssrc%smain%s",baseDirPath,Constant.FILE_SEPARATOR,Constant.FILE_SEPARATOR,Constant.FILE_SEPARATOR);
