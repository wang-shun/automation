    ...
    public static Map<String, Object> load(String prefix) throws IOException {
        ...
        if (null == testYmlIs) {
            ...
            if (null == ymlIs) {
                ...
                throw new MyRuntimeException(testYmlName + " and " + ymlName
                        + " both NOT found.");
            }
            ...
            try {
                ...
                throw new MyRuntimeException("load " + ymlName + " fail.", e);
            } finally {
                ymlIs.close();
            }
        ...
        if (omap == null || omap.size() == 0) {
            throw new MyRuntimeException("load " + testYmlName + " or "
                    + ymlName + " fail.");
        }
        ...
        if (!appConfYmlFile.exists()) {
            ...
            try {
                ...
                throw new MyRuntimeException("load " + appConfYmlPath
                        + " fail.", e);
            } finally {
                fis.close();
            }
        ...
        if (!homeYmlFile.exists()) {
            ...
            if (null == newMap) {
                log.error("load {} fail.", homeYmlPath);
                throw new MyRuntimeException("load " + homeYmlPath
                        + " fail. result is null.");
            }
