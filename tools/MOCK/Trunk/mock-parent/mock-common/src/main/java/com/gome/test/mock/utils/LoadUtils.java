...
public class LoadUtils {
    ...
    public static void initLog4jProperties() {
        //未打包时读取配置
        String file = FileUtils.class.getClassLoader().getResource("properties/log4j.properties").getFile();
        ...
        //读取jar包内配置文件
        InputStream in = FileUtils.class.getClassLoader().getResourceAsStream("properties/log4j.properties");
