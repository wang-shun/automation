...
import com.gome.test.mock.dubbo.DubboHeader;
import com.gome.test.mock.dubbo.DubboHessianRequest;
import com.gome.test.mock.dubbo.DubboHessianResponse;
import com.gome.test.mock.dubbo.pipe.AbstractDubboPipe;
import com.gome.test.mock.exception.MyRuntimeException;
import com.gome.test.mock.utils.CollectionUtil;
import com.gome.test.mock.utils.Logger;
import com.gome.test.mock.utils.YmlUtil;
...
public final class DubboHessianPipe extends AbstractDubboPipe<DubboHessianRequest, DubboHessianResponse> {
	...
	public void decodeDubboRequest(DubboData dd, Request<DubboHessianRequest> request) throws Exception {
	    ...
	    if( (flag & FLAG_EVENT) != 0 ){
	        ...
	        throw new MyRuntimeException("Unsupport serialization type. flag is " + flag );
	    }
	...
	public void decodeDubboResponse(DubboData dd, Response<DubboHessianResponse> response) throws Exception {
        ...
        if( (flag & FLAG_EVENT) != 0 ){
            ...
            if( resvalue == RESPONSE_WITH_EXCEPTION ){
                ...
                throw new MyRuntimeException("Unrecognized response value. resvalue is " + resvalue);
            }
    ...
    @Override
    public boolean filterReceivedInStub(HandlerContext<DubboHessianResponse, DubboHessianRequest> ctx,Message<DubboHessianRequest> msg){
    ...
    @Override
    public boolean filterReceivedInDriver(HandlerContext<DubboHessianRequest, DubboHessianResponse> ctx,Message<DubboHessianResponse> msg){
