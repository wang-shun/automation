package com.gome.test.mock.dubbo.pipe;
...
import com.gome.test.mock.core.event.SingleThreadEventExecutor;
...
public abstract class AbstractDubboPipe<Q, R> extends Pipe<Q, R> {
    ...
    private boolean decodeDubboData(Buffer buf, DubboData dd){
        ...
        if( magicNumber != MAGIC_NUMBER ){
            ...
            // NOT rollback
            throw new MyRuntimeException("Wrong magic number["+magicNumber+"] expected ["+MAGIC_NUMBER+"]");
        }
