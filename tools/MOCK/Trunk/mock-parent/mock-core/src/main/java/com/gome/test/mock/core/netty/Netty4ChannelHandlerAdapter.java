...
import com.gome.test.mock.core.Spliter;
import com.gome.test.mock.core.event.ConnectedEventTask;
import com.gome.test.mock.core.event.DisconnectedEventTask;
import com.gome.test.mock.core.event.ReceivedEventTask;
...
//    private ChannelHandlerContext realCtx;
    ...
    public Netty4ChannelHandlerAdapter(NettyChannel<O, I> channel, Spliter spliter, Executor executor){
    ...
    @Override
    public void exceptionCaught(ChannelHandlerContext nettyctx, Throwable cause) throws Exception {
    ...
    @Override
    public void deregister(ChannelHandlerContext nettyctx, ChannelPromise promise) throws Exception {
    ...
    @Override
    public void channelRead(ChannelHandlerContext nettyctx, Object msg) throws Exception {
    ...
    @Override
    public void userEventTriggered(ChannelHandlerContext nettyctx, Object evt) throws Exception {
    ...
    @Override
    public void connect(ChannelHandlerContext nettyctx, SocketAddress remoteAddress, SocketAddress localAddress, ChannelPromise promise) throws Exception {
