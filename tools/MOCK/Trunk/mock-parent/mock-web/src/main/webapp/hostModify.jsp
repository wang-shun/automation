...
<div id="main-container">
    ...
    <div id="main-panel_1">
        ...
        <div class="tab-content" id="main-panel-data">
            <div class="tab-pane active" id="editor-panel">
                ...
                <!--api section-->
                <div class="collapse" id="table-section" style="display: inline;">
                    <div class="row" style="margin-left: 0px; margin-top: 4px">

                    </div>
                    <ul id="context-table" class="ui-sortable">
                        <li >
                            <span class="icon-th"></span>
                            <span class="badge">01</span>
                            <span>服务名称</span>
                            <div class="input-append">
                                <input style="margin-left: 10px;width: 450px;"  id="txt_host_name"  type="text" value="${service_name}" class="input-text-light"
                                       placeholder="" oldvalue="${service_name}" data-arg>
                    ...
                    <span class="dropdown-toggle" data-toggle="dropdown" style="margin-left: 15px;">
                      是否有效：
                            ...
                            <div class="input-append">
                                <input type="checkbox"  id="checkbox_host_enable" oldvalue="${enabel}" />
                            </div>
                        </li>
                        <li>
                            <span class="icon-th"></span>
                            ...
                            <span> 服务域名 </span>
                            <div class="input-append">
                                <input style="margin-left: 10px;width: 700px;"  id="txt_host_domain"  type="text" value="" class="input-text-light"
                                       placeholder="" oldvalue="${host_domain}"  data-arg>
                            </div>
                        </li>
                        <li>
                            <span class="icon-th"></span>
                            ...
                            <span> 服务地址 </span>
                            <div class="input-append">
                                <input style="margin-left: 10px;width: 700px;"  id="txt_host_url"  type="text" value="" class="input-text-light"
                                       placeholder=""  oldvalue="${host_url}" data-arg>
                            </div>
                        </li>
                        <li>
                            <span class="icon-th"></span>
                            ...
                            <span> 服务端口 </span>
                            <div class="input-append">
                                <select style="margin-left: 10px; width: 700px;" oldvalue="${host_port}" id="drop_host_port" ></select>
                            </div>
                        </li>
                        <li>
                            <span class="icon-th"></span>
                            ...
                            <span> 服务类型 </span>
                            <div class="input-append">
                                <select style="margin-left: 10px; width: 700px;" oldvalue="${host_type}" id="drop_host_hosttype" ></select>
                            </div>
                        </li>
                        <li>
                            <span class="icon-th"></span>
                            ...
                            <span> 协议类型 </span>
                            <div class="input-append">
                                <select style="margin-left: 10px; width: 700px;" oldvalue="${host_protocol}" id="drop_host_protocoltype" ></select>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="row" style="margin-left: 20px" id="btn-div">
                        <div class="pull-left">
                            <button class="btn btn-primary" id="btn-save" hostid="${host_id}"  hosttype="${host_types}">
                                保存
                            </button>
                            <button class="btn btn-info" id="btn-send" onclick="window.history.back(-1)">
                                放弃
                            </button>
    ...
    <script type="text/javascript" src="/js/hostModify.js"></script>
