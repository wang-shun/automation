    ...
    <div id="main-panel_1">
        ...
        <div class="tab-content" id="main-panel-data">
            <div class="tab-pane active" id="editor-panel">
                ...
                <!--template section-->
                <div class="collapse" id="template-section" style="display: inline;">
                    <div class="row" style="margin-left: 0px; margin-top: 4px">

                    </div>
                    <ul id="template-table" class="ui-sortable">
                        <li >
                            <span class="icon-th"></span>
                            <span class="badge">01</span>
                            <span>模板名称</span>
                            <div class="input-append">
                                <input style="margin-left: 10px;"  id="txt_template_name"  type="text" value="" class="input-text-light"
                                       placeholder="" template_name="" data-arg>
                    ...
                    <span class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <div class="input-append">
                                <input type="checkbox"  id="checkbox_template_enable" />
                            </div>
                        </li>
                        <li>
                            <span class="icon-th"></span>
                            ...
                            <div class="">
                                 <span class="add-on-inline dropdown-toggle"  data-toggle="dropdown"
                                    ...
                                    </span><textarea class="form-control" rows="20" id="txt_template_content" style="width: 90%; margin-left: 0px;"></textarea>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="row" style="margin-left: 20px" id="btn-div">
                        <div class="pull-left">
                            <button class="btn btn-primary" id="btn-save-template" templateId="${template_id}"  templateType="${template_types}">
                                保存
                            </button>
                            <button class="btn btn-info" id="btn-send-template" onclick="window.history.back(-1)">
                                放弃
                            </button>
...
<script type="text/javascript" src="/js/templateModify.js"></script>
