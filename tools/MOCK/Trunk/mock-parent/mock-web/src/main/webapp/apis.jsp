...
<div id="main-container">
                ...
                <div class="tab-pane active" id="-panel">
                    <div id="host_header_div" class="half-color-header filter_div" style="padding: 20px">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    <a id="host_create_new" class="btn btn-primary" href="/api/apiAdd">新增api</a>
                    ...
                    <div id="api_table_div" class="half-trans-green table-div" style="display: inline;">
                        <table id="api_list" class="table table-striped table-bordered table-hover half-trans-green">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>服务名称</th>
    ...
    <div class="modal fade" id="api_sending_modal" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div id="hosts_detail_body" class="modal-body" style="text-align: left">
                    <table id="hosts_detail_table" class="table table-bordered">
                        ...
                        <tr>
                            <th>ID</th>
                            <td><span class="hosts_detail_table_span" id="api_detail_id"></span></td>
                        </tr>
                        <tr>
                            <th>服务名称</th>
                            <td><span class="hosts_detail_table_span" id="api_detail_name"></span></td>
                        </tr>
                        <tr>
                            <th>HOST_名称</th>
                            <td><span class="hosts_detail_table_span" id="api_detail_host_name"></span></td>
                        </tr>
                        <tr>
                            <th>HOST_域名</th>
                            <td><span class="hosts_detail_table_span" id="api_detail_host_domain"></span></td>
                        </tr>
                        <tr>
                            <th>HOST_地址</th>
                            <td><span class="hosts_detail_table_span" id="api_detail_host_url"></span></td>
                        </tr>
                        <tr>
                            <th>关键字</th>
                            <td><span class="hosts_detail_table_span" id="api_detail_keyWords"></span></td>
                        </tr>
                        <tr>
                            <th>描述</th>
                            <td><span class="hosts_detail_table_span" id="api_detail_descript"></span></td>
                        </tr>
                        <tr>
                            <th>工作流程</th>
                            <td><span class="hosts_detail_table_span" id="api_detail_flow_content"></span></td>
                        </tr>
                        <tr>
                            <th>参数方式</th>
                            <td><span class="hosts_detail_table_span" id="api_intercept_param"></span></td>
                        </tr>
                        <tr>
                            <th>模板</th>
                            <td><span class="template_detail_table_span" id="api_template_id"></span></td>
                        </tr>
                        <tr>
                            <th>是否有效</th>
                            <td><span class="hosts_detail_table_span" id="api_detail_enable"></span></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
