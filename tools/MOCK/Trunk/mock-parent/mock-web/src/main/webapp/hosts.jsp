...
<div id="main-container">
                ...
                <div class="tab-pane active" id="-panel">
                    <div id="host_header_div" class="half-color-header filter_div" style="padding: 20px">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    <a id="host_create_new" class="btn btn-primary" href="/host/hostAdd">新增Host</a>
                    ...
                    <div id="host_table_div" class="half-trans-green table-div" style="display: inline;">
                        <table id="host_list" class="table table-striped table-bordered table-hover half-trans-green">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>服务名称</th>
    ...
    <div class="modal fade" id="host_detail_modal" tabindex="-1" role="dialog"
         aria-labelledby="hosts_sending" aria-hidden="false" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div id="hosts_detail_body" class="modal-body" style="text-align: left">
                    <table id="hosts_detail_table" class="table table-bordered">
                        ...
                        <tr>
                            <th>ID</th>
                            <td><span class="hosts_detail_table_span" id="host_detail_id"></span></td>
                        </tr>
                        <tr>
                            <th>服务名称</th>
                            <td><span class="hosts_detail_table_span" id="host_detail_service_name"></span></td>
                        </tr>
                        <tr>
                            <th>域名</th>
                            <td><span class="hosts_detail_table_span" id="host_detail_domain"></span></td>
                        </tr>
                        <tr>
                            <th>Url</th>
                            <td><span class="hosts_detail_table_span" id="host_detail_url"></span></td>
                        </tr>
                        <tr>
                            <th>端口</th>
                            <td><span class="hosts_detail_table_span" id="host_detail_port"></span></td>
                        </tr>
                        <tr>
                            <th>HostType</th>
                            <td><span class="hosts_detail_table_span" id="host_detail_hosttype"></span></td>
                        </tr>
                        <tr>
                            <th>协议类型</th>
                            <td><span class="hosts_detail_table_span" id="host_detail_protocol"></span></td>
                        </tr>

                        <tr>
                            <th>是否有效</th>
                            <td><span class="hosts_detail_table_span" id="host_detail_enable"></span></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
