        ...
        <div class="tab-content" id="main-panel-data">
            ...
            <div class="tab-content" id="api-panel-data">
                <div class="tab-pane active" id="-panel">
                    <div id="host_header_div" class="half-color-header filter_div " style="width: 80%;">
                        <table class="table table-bordered">
                            <thead>
                            <th style="width: 20%;">模板名称</th>
                            <th style="width: 15%;">Host</th>
                            <th style="width: 20%;">消息管理器</th>
                            ...
                            <tr>
                                ...
                                <td>${mq_hostname}</td>
                                <td>${mq_qmgname}</td>
                                <td><a id='tmp_mqs_btn'>${mq_qname}</a></td>
                                <td style=" white-space: nowrap;"><a id='tmp_msg_btn' class="btn btn-primary">生成消息</a> |
                                    <a id='tmp_log_btn' class="btn btn-primary">显示日志</a></td>
                ...
                <div id="tmp_table_div" class="half-trans-green table-div" style="display: inline;">
                    <table id="tmp_list" class="table table-striped table-bordered table-hover half-trans-green">
                        <thead>
                        <tr>
                            <th style="width: 15%;">字段名称</th>
                            <th style="width: 5%;">可空</th>
...
<div class="modal hide fade" id="tmp_table_log_div" tabindex="-1" role="dialog"
     aria-labelledby="hosts_sending" aria-hidden="false" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <table id="log_list" style=" width:100%;"
                       class="table table-striped table-bordered table-hover half-trans-green">
                    <thead>
                    <tr>
                        <th style="width: 10%;">时间</th>
                        <th style="width: 80%;">消息内容</th>
...
<input type="hidden" id="hiddenValue" title="${title}" mq_qname="${mq_qname}" mq_hostname="${mq_hostname}"
       mq_qmgname="${mq_qmgname}"
       mq_channel="${mq_channel}" mq_ccsid="${mq_ccsid}" mq_port="${mq_port}" mq_pid="${mq_pid}"
       mq_type="${mq_type}" mq_iscmd="${mq_iscmd}" template="${template}"/>
