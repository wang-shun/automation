(function () {
    ...
    o(e)
})(), define("ace/ace", ["require", "exports", "module", "ace/lib/fixoldbrowsers", "ace/lib/dom", "ace/lib/event", "ace/editor", "ace/edit_session", "ace/undomanager", "ace/virtual_renderer", "ace/multi_select", "ace/worker/worker_client", "ace/keyboard/hash_handler", "ace/placeholder", "ace/mode/folding/fold_mode", "ace/config"], function (e, t, n) {
    ...
    var r = e("./oop"), i = function () {
        var e = {
            ...
            KEY_MODS: {ctrl: 1, alt: 2, option: 2, shift: 4, meta: 8, command: 8},
            FUNCTION_KEYS: {
                8: "Backspace",
                9: "Tab",
                13: "Return",
    ...
    var r = e("../lib/event"), i = e("../lib/useragent"), s = e("../lib/dom"), o = e("../lib/lang"), u = i.isChrome < 18, a = function (e, t) {
        ...
        if (i.isOldIE) {
            ...
            r.addListener(n, "keyup", function (e) {
                h && (!n.value || N[e.keyCode]) && setTimeout(P, 0);
        ...
        var C = function (e) {
            ...
            c ? (b(), e && t.onPaste(e), c = !1) : e == a[0] ? t.execCommand("del", {source: "ace"}) : (e.substring(0, 2) == a ? e = e.substr(2) : e[0] == a[0] ? e = e.substr(1) : e[e.length - 1] == a[0] && (e = e.slice(0, -1)), e[e.length - 1] == a[0] && (e = e.slice(0, -1)), e && t.onTextInput(e))
        }, L = function (e) {
            if (h)return;
            var t = n.value;
            w(), k(t)
        ...
        r.addCommandKeyListener(n, t.onCommandKey.bind(t)), r.addListener(n, "select", C), r.addListener(n, "input", L), r.addListener(n, "cut", A), r.addListener(n, "copy", O), r.addListener(n, "paste", M), (!("oncut"in n) || !("oncopy"in n) || !("onpaste"in n)) && r.addListener(e, "keydown", function (e) {
        ...
        var _ = function (e) {
            h = !0, t.onCompositionStart(), setTimeout(D, 0)
        }, D = function () {
            if (!h)return;
            t.onCompositionUpdate(n.value)
        }, P = function (e) {
            h = !1, t.onCompositionEnd()
        }, H = o.delayedCall(D, 50);
        r.addListener(n, "compositionstart", _), r.addListener(n, i.isGecko ? "text" : "keyup", function () {
            H.schedule()
        }), r.addListener(n, "compositionend", P), this.getElement = function () {
            return n
        }, this.setReadOnly = function (e) {
            n.readOnly = e
        }, this.onContextMenu = function (e) {
            p || (p = n.style.cssText), n.style.cssText = "z-index:100000;" + (i.isIE ? "opacity:0.1;" : ""), b(t.selection.isEmpty()), t._emit("nativecontextmenu", {target: t});
            var s = t.container.getBoundingClientRect(), o = function (e) {
                n.style.left = e.clientX - s.left - 2 + "px", n.style.top = e.clientY - s.top - 2 + "px"
            };
            o(e);
            if (e.type != "mousedown")return;
            t.renderer.$keepTextAreaAtCursor && (t.renderer.$keepTextAreaAtCursor = null), i.isWin && r.capture(t.container, o, B)
        }, this.onContextMenuClose = B, i.isGecko || r.addListener(n, "contextmenu", function (e) {
            t.textInput.onContextMenu(e), B()
        })
    };
    t.TextInput = a
}), define("ace/mouse/mouse_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/mouse/default_handlers", "ace/mouse/default_gutter_handler", "ace/mouse/mouse_event", "ace/mouse/dragdrop"], function (e, t, n) {
    var r = e("../lib/event"), i = e("../lib/useragent"), s = e("./default_handlers").DefaultHandlers, o = e("./default_gutter_handler").GutterHandler, u = e("./mouse_event").MouseEvent, a = e("./dragdrop").DragdropHandler, f = function (e) {
    ...
    (function () {
        this.$scrollSpeed = 1, this.setScrollSpeed = function (e) {
            ...
            var s = this, o = function (e) {
                ...
                clearInterval(f), s[s.state + "End"] && s[s.state + "End"](e), s.$clickSelection = null, n.$keepTextAreaAtCursor == null && (n.$keepTextAreaAtCursor = !0, n.$moveTextAreaToCursor()), s.isMousePressed = !1
            }, a = function () {
                s[s.state] && s[s.state]()
            };
    ...
    }).call(f.prototype), t.MouseHandler = f
    ...
    function a(e, t) {
        if (e.start.row == e.end.row)var n = 2 * t.column - e.start.column - e.end.column; else var n = 2 * t.row - e.start.row - e.end.row;
        return n < 0 ? {cursor: e.start, anchor: e.end} : {cursor: e.end, anchor: e.start}
    }

    var r = e("../lib/dom"), i = e("../lib/useragent"), s = 5;
    (function () {
        this.onMouseDown = function (e) {
            ...
            if (t && !r.isFocused()) {
                r.focus();
                if (this.$focusWaitTimout && !this.$clickSelection)return this.setState("focusWait"), this.captureMouse(e), e.preventDefault()
            }
            return !t || this.$clickSelection || e.getShiftKey() ? this.startSelect(n) : t && (this.mousedownEvent.time = (new Date).getTime(), this.setState("dragWait")), this.captureMouse(e), e.preventDefault()
        ...
        e.on("click", function (t) {
            ...
            if (n == "foldWidgets") {
                ...
                if (f) {
                    ...
                    l ? i.removeFold(l) : (i.addFold("...", f), e.renderer.scrollCursorIntoView({
                        row: f.start.row,
                        column: 0
                    }))
                }
...
}), define("ace/edit_session", ["require", "exports", "module", "ace/config", "ace/lib/oop", "ace/lib/lang", "ace/lib/net", "ace/lib/event_emitter", "ace/selection", "ace/mode/text", "ace/range", "ace/document", "ace/background_tokenizer", "ace/search_highlight", "ace/edit_session/folding", "ace/edit_session/bracket_match"], function (e, t, n) {
...
}), define("ace/lib/net", ["require", "exports", "module", "ace/lib/useragent"], function (e, t, n) {
    var r = e("./useragent");
    t.get = function (e, n) {
        var r = t.createXhr();
...
}), define("ace/mode/text", ["require", "exports", "module", "ace/tokenizer", "ace/mode/text_highlight_rules", "ace/mode/behaviour", "ace/unicode"], function (e, t, n) {
    ...
    (function () {
        this.$arrayTokens = function (e) {
            ...
            while (u = o.exec(e)) {
                ...
                if (p)if (typeof c == "string")!!h && h.merge === !1 || l.type !== c ? (l.type && a.push(l), l = {
                    type: c,
                    value: p
                }) : l.value += p; else {
    ...
    var r = e("../lib/lang"), i = function () {
        this.$rules = {start: [{token: "empty_line", regex: "^$"}, {token: "text", regex: ".+"}]}
    };
    (function () {
...
}), define("ace/keyboard/hash_handler", ["require", "exports", "module", "ace/lib/keys"], function (e, t, n) {
    function i(e, t) {
    ...
    var g = function (e, t) {
        ...
        this.canvas = r.element, this.$markerFront = new l(this.content), this.$cursorLayer = new h(this.content), this.$horizScroll = !1, this.$horizScrollAlwaysVisible = !1, this.$animatedScroll = !1, this.scrollBar = new p(this.container), this.scrollBar.addEventListener("scroll", function (e) {
            ...
            offset: 0,
            height: 1
        }, this.$loop = new d(this.$renderChanges.bind(this), this.container.ownerDocument.defaultView), this.$loop.schedule(this.CHANGE_FULL), this.updateCharacterSize(), this.setPadding(4)
    };
    (function () {
    ...
    (function () {
        i.implement(this, o), this.setSession = function (e) {
            ...
            for (; ;) {
                ...
                n.push("<div class='ace_gutter-cell ", f[i] || "", l[i] || "", h.className, "' style='height:", this.session.getRowLength(i) * e.lineHeight, "px;'>", c = i + 1);
                if (a) {
                    var p = a[i];
                    p == null && (p = a[i] = this.session.getFoldWidget(i)), p && n.push("<span class='ace_fold-widget ace_", p, p == "start" && i == u && i < o.end.row ? " ace_closed" : " ace_open", "' style='height:", e.lineHeight, "px", "'></span>")
                }
                n.push("</div>"), i++
            }
    ...
    (function () {
        r.implement(this, u), this.EOF_CHAR = "¶", this.EOL_CHAR = "¬", this.TAB_CHAR = "→", this.SPACE_CHAR = "·", this.$padding = 0, this.setPadding = function (e) {
            ...
            var color = "";
            if (i && i.length > 0) {
                if (i[0].value.indexOf("运行状态：SUCCESS") > -1)
                    color = ";color:green";

                if (i[0].value.indexOf("运行状态：FAILURE") > -1 || i[0].value.indexOf("[ERROR]") > -1)
                    color = ";color:red";
            }
            n || e.push("<div class='ace_line' style='height:", this.config.lineHeight, "px" + color + "'>");
            if (i.length) {
...
}), define("ace/range_list", ["require", "exports", "module"], function (e, t, n) {
    var r = function () {
        this.ranges = []
    };
    (function () {
