...
import com.gome.test.pom.common.HttpConstants;
import com.gome.test.pom.json.JsonDateValueProcessor;
...
public class BaseController {
	...
	public String responseResult(Object obj){
		...
		if(obj != null){
		    logger.info("backend response object is : ", obj);
		    JsonConfig jsonConfig = new JsonConfig(); 
		    jsonConfig.registerJsonValueProcessor(Date.class, new JsonDateValueProcessor());
		    jsonObj = JSONObject.fromObject(obj, jsonConfig);
		    logger.info("backend response data is : " + jsonObj);
		...
		logger.info("output data is : {}", jsonObj.toString());
	...
	public String responseSuccess(Object obj){
		JSONObject jsonObj = null;
		if(obj != null){
		    logger.info("response object is : {}", obj);
		    JsonConfig jsonConfig = new JsonConfig(); 
		    jsonConfig.registerJsonValueProcessor(Date.class, new JsonDateValueProcessor());
		    jsonObj = JSONObject.fromObject(obj, jsonConfig);
//		    logger.info("后端返回数据：" + jsonObj);
		...
		logger.info("response json is : {}", jsonObj.toString());
		return jsonObj.toString();
	}
...
//			logger.info("respon：" + jsonObj);
		}
		logger.info("response json: {}", jsonObj.toString());
		return jsonObj.toString();
	}
	...
	public String responseSuccess(Object obj, String msg){
		JSONObject jsonObj = null;
		if(obj != null){
		    logger.info("backend response object :{}", obj);
		    JsonConfig jsonConfig = new JsonConfig(); 
		    jsonConfig.registerJsonValueProcessor(Date.class, new JsonDateValueProcessor());
		    jsonObj = JSONObject.fromObject(obj, jsonConfig);
		    logger.info("backend response data:" + jsonObj);
		    jsonObj.element(HttpConstants.RESPONSE_RESULT_FLAG_ISERROR, false);
		    jsonObj.element(HttpConstants.SERVICE_RESPONSE_RESULT_MSG, msg);
		}
		logger.info("output result {}", jsonObj.toString());
		return jsonObj.toString();
	}
