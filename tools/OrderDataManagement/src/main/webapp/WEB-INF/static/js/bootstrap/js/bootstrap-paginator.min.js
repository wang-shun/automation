!function ($) {
	...
	BootstrapPaginator.prototype = {
		init : function (element, options) {
			...
			if (2 === version && !this.$element.is("div"))
		...
		buildPageItem : function (type, page) {
			...
			this.options.useBootstrapTooltip ? (tooltipOpts = $.extend({}, this.options.bootstrapTooltipOptions, {
						title : title
	...
	$.fn.bootstrapPaginator = function (option) {
		...
		return $(this).each(function (index, item) {
			...
			if (!data)
				return data = new BootstrapPaginator(this, options), $this = $(data.$element), $this.data("bootstrapPaginator", data), void 0;
