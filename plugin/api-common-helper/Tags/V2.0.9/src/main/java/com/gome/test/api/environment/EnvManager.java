...
//
    ...
    public void set(String name, String value) {
        ApiUtils.getContext().put(name, value);
    }
    ...
    public void removeContext(String name) {
        ApiUtils.getContext().remove(name);
    }
    ...
    {
        ApiUtils.addAESAndBASE64Context(name,value,key);
    }
    ...
    public void addMD5SortedMapContext(String name, String value, String key) {
        ApiUtils.addMD5SortedMapContext(name,value,key);
    }
}
